...
public class WeatherDataParser {
     ...
     */
    public static ImmutableList<String> getWeatherDataFromJson(String forecastJsonStr, UnitType unitType)
        ...
        ImmutableList.Builder<String> forecastData = ImmutableList.builder();
        for(int i = 0; i < weatherArray.length(); i++) {
            ...
            forecastData.add(day + " - " + description + " - " + highAndLow);
        }
     ...
     */
    private static String formatHighLows(double high, double low, UnitType unitType) {
